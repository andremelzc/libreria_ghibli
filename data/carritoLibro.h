...
void agregarCarrito(int id_usuario){
    ...
    do{
        ...
        int id_carrito = countLinesFiles("output/carrito.csv") + agregado;
        ...
        if(confirmacion_agregar){
            ...
            insertarCarritoFinal(&listaCarritoActual, structCarritoActual);agregado++;
            
            seguir_agregando = false;
            cout<<"Desea agregar otro producto a su carrito: "<<endl;
            cout<<"Marque 's' para confirmar:"<<endl;
            cin>>desicion;
            if(desicion == 's' || desicion == 'S'){
